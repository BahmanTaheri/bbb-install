...
main() {
  ...
  if [ "$DISTRO" == "focal" ]; then
    ...
    echo "deb [ arch=amd64 ] https://repo.mongodb.org/apt/ubuntu focal/mongodb-org/4.4 multiverse" | sudo tee /etc/apt/sources.list.d/mongodb-org.list
...
install_greenlight_v3(){
  ...
  say "preparing and checking the environment to install/update greelight-v3..."
